...
echo "<p> Обратите внимание, что username и password должны быть URL-encoded , специальные символы должны быть percent-encoded. Например @ заменяется на %40, # заменяется на %23, / - %2F, : - %3A, ? - %3F, & - %26, + - %2B, % - %25, $ - %24, Space - %20</p>";
