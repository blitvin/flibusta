...
echo "<input type='checkbox' class='form-check-input' id='show_password' onclick=\"document.getElementById('password').type = this.checked ? 'text' : 'password'\">";
echo "<label class='form-check-label' for='show_password'>Показать пароль</label>";
echo "</div>";
echo "</div>";
