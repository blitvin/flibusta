...
ALTER TABLE public.fav_lists OWNER TO :FLIBUSTA_DBUSER;
...
ALTER TABLE public.login_attempts OWNER TO :FLIBUSTA_DBUSER;
...
ALTER TABLE public.user_tokens OWNER TO :FLIBUSTA_DBUSER;
